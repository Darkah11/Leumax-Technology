...
import hero from "@/public/academy/office-365-bg.jpg";
      ...
      <section className="px-5 lg:px-16 py-24">
        <div className=" max-w-[850px] m-auto">
          <div>
            ...
            <p className=" pt-5">
              Office 365, now known as Microsoft 365,  Microsoft 365 provides a
              comprehensive suite of tools and services to empower individuals
              and organizations to work smarter, communicate better, and achieve
              more, whether they are in the office or on the go.
            </p>
          </div>
          ...
          <div className=" md:py-12 py-8 md:px-10 px-5 rounded-lg price-card text-white-10 mt-12">
            ...
            <h2 className=" md:text-5xl text-3xl font-medium py-3">₦100,000</h2>
            <p>
